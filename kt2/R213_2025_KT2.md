...
| **Payment Adapter** | Rust + Stripe SDK | Upravlja  payment lifecycle-om, verifikuje webhooks, publishes Kafka events | N/A (stateless) |
...
Za [PCI compliance](https://www.fortra.com/blog/what-pci-compliance), adapter koristi Stripe Elements za tokenizaciju na klijentu, izbegavajući rukovanje PAN-om (PCI SAQ A). Audit logovi idu u PostgreSQL sa tamper-proof hash-ovima. Preporuka je da se nikad ne čuva PII u Redis-u.
